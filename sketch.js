...
function start(){
    ...
    textSize(30)
    fill('black')
    text('So there will be a forest and, in the forest, there is a golden deer.',width/2-400,150)
    text('We have to save it. There will also be super power for the player. ',width/2-400,200)
    text('There will also be enemies like tigers. It will be a adventures game. 😊',width/2-410,250)
    text('Press space to start the game.',width/2-200,300)
